    ...
    <header class="p-3 bg-dark text-white">
          ...
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-21 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="fmrClientes.aspx" class="nav-link px-2 text-white">Consultas</a></li>
                    <li>
                        <asp:ImageButton
                                ID="ImageButton1"
                                runat="server"
                    ...
                    <li><a href="#" style="align-content:center" class="nav-link px-2 text-white">Ingresos</a></li>
                    <li>
                        <asp:ImageButton
                                ID="ImageButton5"
                                runat="server"

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmManCategoria.aspx.cs" Inherits="CapasCxC.Interfaces.Mantenimientos.frmManCategoria" %>
        ...
        <header class="p-3 bg-dark text-white">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-21 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li>
                        <asp:ImageButton runat="server" ID="btnBorrar" ImageUrl="~/img/borrar.png" AlternateText="Borrar" OnClick="btnBorrar_Click" class="iconos" /></li>

                    <li><a href="#" class="nav-link px-2 text-white">Borrar</a></li>
                    <li>
                        <asp:ImageButton runat="server" ID="btnActualizar" ImageUrl="~/img/actualizar.png" AlternateText="Actualizar" OnClick="btnActualizar_Click" class="iconos" /></li>

                    <li><a href="#" class="nav-link px-2 text-white">Actualizar</a></li>
                    <li>
                        <asp:ImageButton runat="server" ID="btnGuardar" ImageUrl="~/img/guardar.png" AlternateText="Guardar" OnClick="btnGuardar_Click" class="iconos" /></li>

                    <li><a href="#" class="nav-link px-2 text-white">Guardar</a></li>
                    <li>
                        <asp:ImageButton runat="server" ID="btn_Buscar" ImageUrl="~/img/buscar.png" AlternateText="Consulta de Clientes" OnClick="btn_Buscar_Click" class="iconos" /></li>

                    <li><a href="frmCrudCliente.aspx" class="nav-link px-2 text-white">Buscar</a></li>
                    <li>
                        <asp:ImageButton runat="server" ID="btnInspeccionar" ImageUrl="~/img/inspect.png" AlternateText="Inspeccionar" OnClick="btnInspeccionar_Click" class="iconos" /></li>
                    ...
                    <div>
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="padding:25px">
                                    <asp:TextBox ID="TextBoxDias" runat="server" BackColor="#FFF7E7" Placeholder="Días" onkeypress="if (event.keyCode==13) return false;"></asp:TextBox>
                                   </td>
                                <td style="padding:25px">
                                    <asp:TextBox ID="TextBoxInteres" runat="server" BackColor="#FFF7E7" Placeholder="Interes" onkeypress="if (event.keyCode==13) return false;"></asp:TextBox>
                                   </td>
